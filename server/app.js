...
app.post('/api/posts', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, category, thought, post, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, title = _a.title, category = _a.category, thought = _a.thought;
...
// Update a post
app.put('/posts/:postId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, thought, postId, updatedPost, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, title = _a.title, thought = _a.thought;
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.post.update({
                        ...
                        data: { title: title, thought: thought },
                    })];
            case 2:
                updatedPost = _b.sent();
